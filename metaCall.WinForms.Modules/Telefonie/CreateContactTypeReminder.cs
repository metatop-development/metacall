...
{
    [ToolboxItem(false)]
    public partial class CreateContactTypeReminder : UserControl, ISupportInitialize, IInitializeCall
    {
        public event EventHandler<ContactTypeChangedEventArgs> ContactTypeChanged;
        public event SponsorPhoneChangeEventHandler SponsorPhoneChanged;
        ...
        public CreateContactTypeReminder()
        {
            InitializeComponent();
        }
        ...
        private void UpdateContactTypeInformations()
        {
            if (!DesignMode)
           {
              ...
              // this.txtCurrentNumber.ReadOnly = true;
                ...
                List<ContactType> contactTypes = MetaCall.Business.ContactType.ContactTypesSponsoringCallJob;
                ...
                grpContactType.Size = new Size(480, ((1 + (contactTypes.Count / 2)  ) * 20)+10);
                int buttonStart = 10;
                ...
                this.formHeight = grpContactType.Size.Height + grpPhoneNumber.Size.Height + 15;
        ...
        void radiobtn_CheckedChanged(object sender, EventArgs e)
        {
            ...
            SaveCurrentPhoneNumber(this.phoneArt);
        ...
        private void CreateContactTypeReminder_Load(object sender, EventArgs e)
        {
            UpdateContactTypeInformations();
        }

        private void SaveCurrentPhoneNumber(PhoneArt phoneArt)
        {
            switch (phoneArt)
            {
                case PhoneArt.Alternativ:
                    ...
                    break;
                case PhoneArt.Mobil:
                    this.mobilNummer = this.txtCurrentNumber.Text;
                    break;
                case PhoneArt.Telefon:
                    this.telefonNummer = this.txtCurrentNumber.Text;
                    break;
            }

            this.currentCall.CallJob.Sponsor.TelefonNummer = this.telefonNummer;
            this.currentCall.CallJob.Sponsor.MobilNummer = this.mobilNummer;
            this.currentCall.CallJob.Sponsor.Additions.Phone1 = this.telefonNummer;
            this.currentCall.CallJob.Sponsor.Additions.Phone2 = this.mobilNummer;
            this.currentCall.CallJob.Sponsor.Additions.Phone3 = this.alternativNummer;

            OnSponsorPhoneChange(new SponsorPhoneChangeEventArgs(this.currentCall.CallJob.Sponsor));
        }

        protected void OnSponsorPhoneChange(SponsorPhoneChangeEventArgs e)
        {
            if (SponsorPhoneChanged != null)
                SponsorPhoneChanged(this, e);
        }
        ...
        private void btnTelefon_Click(object sender, EventArgs e)
        {
            ...
            this.btnTelefon.ForeColor = System.Drawing.Color.Red;
            SaveCurrentPhoneNumber(this.phoneArt);
            this.phoneArt = PhoneArt.Telefon;
            this.txtCurrentNumber.Text = this.telefonNummer;
        }
        ...
        private void btnAlternativ_Click(object sender, EventArgs e)
        {
            ...
            this.btnAlternativ.ForeColor =  System.Drawing.Color.Red;
            SaveCurrentPhoneNumber(this.phoneArt);
            this.phoneArt = PhoneArt.Alternativ;
            this.txtCurrentNumber.Text = this.alternativNummer;
        }
        ...
        public void InitializeCall(Call call)
        {
            ...
            TelefonNummer = call.CallJob.Sponsor.TelefonNummer;
            MobilNummer = call.CallJob.Sponsor.MobilNummer;
            AlternativNummer = call.CallJob.Sponsor.Additions.Phone3; ;
        ...
        {
            foreach (RadioButton btn in grpContactType.Controls)
            {
                btn.Checked = false;
            }
        }
        ...
        private void txtCurrentNumber_Leave(object sender, EventArgs e)
        {
            SaveCurrentPhoneNumber(this.phoneArt);
        }
    }
