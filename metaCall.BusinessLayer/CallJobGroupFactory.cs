...
namespace metatop.Applications.metaCall.BusinessLayer
{
    ...
    {
        /// <summary>
        /// Wird ausgel�st, wenn eine neue Anrufgruppe ermittelt wurde
        /// </summary>
        public event CallJobGroupCreatedEventHandler CallJobGroupCreated;

        /// <summary>
        /// Wird ausgel�st, wenn die Methode Analyse einen weiteren Sponsor bearbeitet
        /// </summary>
        ...
        /// Die CallJobGruppe wird in einem Container-Element gehalten und die zugeh�rigen Sponsoren in 
        /// einer Liste
        /// </summary>
