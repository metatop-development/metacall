...
{
    public class TTListener: ActivityListenerBase
    {
        ...
        public TTListener(MetaCallBusiness metacallBusiness)
        {
        ...
        private void SaveStartItem()
        {
            ...
            currentItem.ActivityTimeItemType = "Telefonzeit";
        ...
        public override void ActivityRaised(ActivityLoggedEventArgs e)
        {
            ...
            /* Start */
            if (activity.GetType() == typeof(DialConnected))
            {
                Call call = ((DialConnected) activity).Call;
                this.Start();
