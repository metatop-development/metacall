...
{
    [ModulIndex(99)]
    public partial class Arbeitszeitauswertung : UserControl, IModulMainControl
    {
        ...
        private class Configuration: ModulConfigBase
        {
            ...
            {
                return new StartUpMenuItem("Arbeitszeiten", "Auswertungen");
            }
        ...
        private void RefreshReport()
        {
            ...
            try
            {
                ...
                report.Load(@"Arbeitszeiten.rpt", CrystalDecisions.Shared.OpenReportMethod.OpenReportByTempCopy);
